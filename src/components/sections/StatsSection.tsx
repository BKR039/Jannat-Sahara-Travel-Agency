    ...
    <section className="mx-auto max-w-7xl px-4 py-16 md:px-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {data.map((s) => (
          <div
            key={s.id}
            className="group flex flex-col items-center gap-3 rounded-lg border border-border bg-gradient-to-b from-card to-card/50 p-6 text-center shadow-sm transition-all duration-base ease-standard hover:-translate-y-1 hover:shadow-lg"
          >
