...
function OverviewSection() {
  ...
  const rangeLabel = dateRangeOptions.find((option) => option.value === dateRange)?.label;
    ...
    <article className="rounded-xl border bg-card p-3 md:p-4">
      <div className="flex flex-col gap-5 md:gap-8">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <p className="text-xs font-medium text-muted-foreground md:text-sm">{metric.label}</p>
        </div>
        ...
        <div className="flex flex-col gap-2 md:gap-3">
          ...
          {metric.trend ? (
            <div className="flex items-center gap-1">
              {metric.trend.tone === "positive" ? (
                ...
                <span className="text-xs font-medium text-primary">{metric.trend.value}</span>
              )}
          ...
          {metric.footnote ? (
            <p className="text-xs font-medium text-muted-foreground">{metric.footnote}</p>
          ) : null}
        </div>
      </div>
    </article>
      ...
      <div className="relative h-100 overflow-hidden rounded-3xl border bg-secondary dark:bg-card/40">
        ...
        <div className="absolute top-4 right-4 left-4 z-10 flex items-center gap-0.5 md:right-auto">
          <div className="flex size-12 shrink-0 items-center justify-center gap-2 rounded-xl border bg-card md:w-auto md:justify-start md:px-3">
            ...
            <span className="hidden text-sm text-success md:inline">Live Pipeline</span>
          </div>
