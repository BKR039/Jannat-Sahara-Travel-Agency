      ...
      <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-lg">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="grid gap-2">
            ...
            <label
              htmlFor="b-passport"
              className="flex cursor-pointer items-center gap-3 rounded-xl border border-dashed border-border bg-muted/40 px-4 py-3 text-sm transition hover:bg-muted"
            >
              {file ? (
                <>
